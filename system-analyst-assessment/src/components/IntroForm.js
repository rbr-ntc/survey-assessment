					...
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1'>
							...
							<div className='text-blue-700 space-y-2'>
								<p>
									Приложение <strong>НЕ собирает и НЕ сохраняет</strong> ваши персональные данные в соответствии с законодательством Российской Федерации.
								</p>
								<p>
									<strong>Email адрес:</strong> используется только для идентификации результатов тестирования и <strong>НЕ сохраняется в базе данных</strong>. Вы можете указать любой email адрес.
								</p>
								<p>
									<strong>Ваше имя:</strong> используется только для персонализации отчета и рекомендаций.
								</p>
								<p className='text-xs text-blue-600 mt-2'>
									Все данные тестирования анонимны и не содержат персональной информации.
								</p>
							</div>
						</div>
					</div>
